...
import { getNonce } from "src/utils";
  ...
  return (
    <Helmet>
      <meta
        ...
        content={`default-src 'self'; script-src 'self' www.google-analytics.com www.googletagmanager.com 'nonce-${curNonce}'; style-src 'self' 'unsafe-inline' ; img-src 'self' blob: data: ${API1_URL} www.google-analytics.com www.googletagmanager.com; connect-src 'self' ${API1_URL} www.google-analytics.com ws:`}
      />
